...
public:
	...
	*/
	...
	virtual int32 VoiceSDKLogin(const FString& UserName, const FString& Password, const FString& Params) = 0;
};
...
public:
	...
	virtual int32 VoiceSDKLogin(const FString& UserName, const FString& Password, const FString& Params) override;
